...
metadata_dna %>% 
  ...
  ggplot(aes(x = Protocol, y = Absorbance_ratio, color = Protocol)) +
  ...
  theme_classic() +
  labs(y = "Abs 260/230 nm \nUnpurified", x = NULL) +
  #theme(legend.position = "bottom") +
  theme(axis.text.x = element_text(angle = 90, hjust=1))
  ggtitle("DNA purity before purification 260/230")
...
purity_B =
  ...
  #theme(legend.position = "bottom") +
  theme(axis.text.x = element_text(angle = 90, hjust=1))
  ggtitle("DNA purity after purification 260/230")
...
metadata_dna %>% 
  ...
  facet_grid(~Sample_type + Filter_type) +
  theme_classic() +
  labs(y = "Abs 260/280 nm \nUnpurified", x = NULL) +
  #theme(legend.position = "bottom") +
  theme(axis.text.x = element_text(angle = 90, hjust=1))
  ggtitle("DNA purity before purification 260/280")
...
purity_D =
  ...
  #theme(legend.position = "bottom") +
  theme(axis.text.x = element_text(angle = 90, hjust=1))
  ggtitle("DNA purity after purification 260/280")
  
purity_plots = plot_grid(purity_A, 
                         purity_B, 
                         purity_C, 
                         purity_D, 
                         labels  = c("A", "B", "C", "D"), 
