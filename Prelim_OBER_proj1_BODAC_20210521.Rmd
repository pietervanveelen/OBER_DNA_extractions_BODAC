...
dna_data <- read.table("OBER_DNA_conc_data.txt", header = T, sep = "\t", dec = ".") %>% as_tibble()
...
ggsave(alpha_div, filename = "plot_alpha_div_OBER.pdf", width = 8, height = 6)
...
#pdf("plot_beta_diversity_OBER_proj1_BODAC_Granules_only.pdf", useDingbats = F, width = 7, height = 12)
...
#pdf("plot_venn_diagram_OBER_proj1_BODAC_Protocols_none_0.001_0.01_0.5pct.pdf", useDingbats = F, width = 7, height = 13)
...
ggsave("OBER_stacked_barplot_Genus.pdf", width = 5, height = 4, units = "in") 
